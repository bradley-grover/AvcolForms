...
{
    public partial class FormsUpdate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Closes = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    Title = table.Column<string>(type: "character varying(72)", maxLength: 72, nullable: false),
                    Description = table.Column<string>(type: "character varying(72)", maxLength: 72, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RespondsToId = table.Column<Guid>(type: "uuid", nullable: true),
